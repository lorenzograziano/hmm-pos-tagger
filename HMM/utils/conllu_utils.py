...
def get_train_data():
    return get_data('/home/lorenzo/PycharmProjects/UD_Italian-ISDT/it_isdt-ud-train.conllu', True)  # it_isdt-ud-train


def get_test_data(tag=False):
    return get_data('/home/lorenzo/PycharmProjects/UD_Italian-ISDT/it_isdt-ud-test.conllu', tag)
